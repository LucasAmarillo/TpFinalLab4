                ...
                <div class="row container-fluid">
                    <div class="col-6">
                        ...
                        <div class="mb-1 col-8 mx-auto">
                            ...
                            <input type="date" id="fecha_inscripcion" name="fecha_inscripcion" class="form-control" tabindex="14" placeholder="Fecha de inscripción"
                                value="" required>
                        </div>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="mt-2 col-8 mx-auto text-center">
                        ...
                        <button class="btn btn-info btnEditaCliente justify-content-center" type="submit" tabindex="16"><i class="fa-solid fa-floppy-disk"></i> Guardar</button>
                    </div>
